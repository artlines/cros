  ...
  $.MainCore = {
    ...
    init: function () {
      ...
      $(document).ready(function (e) {
        ...
        if ($('[data-bg-img-src]').length) $.MainCore.helpers.bgImage($('[data-bg-img-src]'));

        // Extends jQuery
        $.MainCore.helpers.extendjQuery();

        // Detect Internet Explorer (IE)
        $.MainCore.helpers.detectIE();

        // Bootstrap Navigation Options
        $.MainCore.helpers.bootstrapNavOptions.init();
