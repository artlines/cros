...
class AdminProgramController extends AbstractController
{
     ...
     * @return object
     */
    public function adminProgramText(Request $request)
    {
     ...
     * @return object
     */
    public function program($year = null, $day = null, Request $request)
    {
        $result = false;
     ...
     * @return object
     */
    public function removeProgram($id, Request $request){
        /** @var Program $program */
        $program = $this->getDoctrine()
            ->getRepository('App:Program')
            ->find($id);
