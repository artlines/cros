...
class SmsController extends AbstractController
{
    ...
    public function generatePassword(Request $request){
        ...
        $logsRepository = $this->getDoctrine()->getRepository('App:Logs');
        /** @var Logs $logs */
    ...
    public function smsCheck(){
        ...
        $organizationRepository = $this->getDoctrine()->getRepository('App:Organization');
     ...
     * @return object
     */
    public function connectionSms(Request $request)
    {
