...
class ApartamentType
{
     ...
     * Set pairs
     *
     * @param \App\Entity\ApartamentPair $pairs
     *
     * @return ApartamentType
     */
    public function setPairs(\App\Entity\ApartamentPair $pairs = null)
    {
        $this->pairs = $pairs;
     ...
     * Add flat
     *
     * @param \App\Entity\Flat $flat
     *
     * @return ApartamentType
     */
    public function addFlat(\App\Entity\Flat $flat)
    {
        $this->flats[] = $flat;
     ...
     * @param \App\Entity\Flat $flat
     */
    public function removeFlat(\App\Entity\Flat $flat)
    {
