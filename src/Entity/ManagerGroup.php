...
class ManagerGroup
{
     ...
     * Add managed
     *
     * @param \App\Entity\Organization $managed
     *
     * @return ManagerGroup
     */
    public function addManaged(\App\Entity\Organization $managed)
    {
     ...
     * @param \App\Entity\Organization $managed
     */
    public function removeManaged(\App\Entity\Organization $managed)
    {
     ...
     * Add manager
     *
     * @param \App\Entity\User $manager
     *
     * @return ManagerGroup
     */
    public function addManager(\App\Entity\User $manager)
    {
     ...
     * @param \App\Entity\User $manager
     */
    public function removeManager(\App\Entity\User $manager)
    {
