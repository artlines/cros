...
class Apartament
{
     ...
     * Add aitoa
     *
     * @param \App\Entity\ApartamentId $aitoa
     *
     * @return Apartament
     */
    public function addAitoa(\App\Entity\ApartamentId $aitoa)
    {
        $this->aitoas[] = $aitoa;
     ...
     * @param \App\Entity\ApartamentId $aitoa
     */
    public function removeAitoa(\App\Entity\ApartamentId $aitoa)
    {
     ...
     * Set apartamentpair
     *
     * @param \App\Entity\ApartamentPair $apartamentpair
     *
     * @return Apartament
     */
    public function setApartamentpair(\App\Entity\ApartamentPair $apartamentpair = null)
    {
     ...
     * Get apartamentpair
     *
     * @return \App\Entity\ApartamentPair
     */
