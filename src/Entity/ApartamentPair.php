...
class ApartamentPair
{
     ...
     * @return ApartamentPair
     */
    public function addApartament(\App\Entity\Apartament $apartament)
    {
     ...
     * @param \App\Entity\Apartament $apartament
     */
    public function removeApartament(\App\Entity\Apartament $apartament)
    {
     ...
     * Add apartamentType
     *
     * @param \App\Entity\ApartamentType $apartamentType
     *
     * @return ApartamentPair
     */
    public function addApartamentType(\App\Entity\ApartamentType $apartamentType)
    {
     ...
     * @param \App\Entity\ApartamentType $apartamentType
     */
    public function removeApartamentType(\App\Entity\ApartamentType $apartamentType)
    {
