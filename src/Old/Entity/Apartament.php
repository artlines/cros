...
class Apartament
{
     ...
     * Add aitoa
     *
     * @param \App\Old\Entity\ApartamentId $aitoa
     *
     * @return Apartament
     */
    public function addAitoa(\App\Old\Entity\ApartamentId $aitoa)
    {
        $this->aitoas[] = $aitoa;
     ...
     * @param \App\Old\Entity\ApartamentId $aitoa
     */
    public function removeAitoa(\App\Old\Entity\ApartamentId $aitoa)
    {
     ...
     * Set apartamentpair
     *
     * @param \App\Old\Entity\ApartamentPair $apartamentpair
     *
     * @return Apartament
     */
    public function setApartamentpair(\App\Old\Entity\ApartamentPair $apartamentpair = null)
    {
