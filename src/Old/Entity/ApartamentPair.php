 ...
 * @ORM\Entity(repositoryClass="App\Repository\ApartamentPairRepository")
 */
class ApartamentPair
{
     ...
     * @return ApartamentPair
     */
    public function addApartament(\App\Old\Entity\Apartament $apartament)
    {
     ...
     * @param \App\Old\Entity\Apartament $apartament
     */
    public function removeApartament(\App\Old\Entity\Apartament $apartament)
    {
     ...
     * Add apartamentType
     *
     * @param \App\Old\Entity\ApartamentType $apartamentType
     *
     * @return ApartamentPair
     */
    public function addApartamentType(\App\Old\Entity\ApartamentType $apartamentType)
    {
     ...
     * @param \App\Old\Entity\ApartamentType $apartamentType
     */
    public function removeApartamentType(\App\Old\Entity\ApartamentType $apartamentType)
    {
