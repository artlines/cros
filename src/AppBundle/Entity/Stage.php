...
class Stage
{
     ...
     * Add corpus1
     *
     * @param \AppBundle\Entity\Corpuses $corpus1
     *
     * @return Stage
     */
    public function addCorpus1(\AppBundle\Entity\Corpuses $corpus1)
    {
     ...
     * @param \AppBundle\Entity\Corpuses $corpus1
     */
    public function removeCorpus1(\AppBundle\Entity\Corpuses $corpus1)
    {
     ...
     * Add corpus2
     *
     * @param \AppBundle\Entity\Corpuses $corpus2
     *
     * @return Stage
     */
    public function addCorpus2(\AppBundle\Entity\Corpuses $corpus2)
    {
     ...
     * @param \AppBundle\Entity\Corpuses $corpus2
     */
    public function removeCorpus2(\AppBundle\Entity\Corpuses $corpus2)
    {
     ...
     * Add corpus3
     *
     * @param \AppBundle\Entity\Corpuses $corpus3
     *
     * @return Stage
     */
    public function addCorpus3(\AppBundle\Entity\Corpuses $corpus3)
    {
     ...
     * @param \AppBundle\Entity\Corpuses $corpus3
     */
    public function removeCorpus3(\AppBundle\Entity\Corpuses $corpus3)
    {
     ...
     * Set realflat1
     *
     * @param \AppBundle\Entity\Flat $realflat1
     *
     * @return Stage
     */
    public function setRealflat1(\AppBundle\Entity\Flat $realflat1 = null)
    {
     ...
     * Set realflat2
     *
     * @param \AppBundle\Entity\Flat $realflat2
     *
     * @return Stage
     */
    public function setRealflat2(\AppBundle\Entity\Flat $realflat2 = null)
    {
     ...
     * Set realflat3
     *
     * @param \AppBundle\Entity\Flat $realflat3
     *
     * @return Stage
     */
    public function setRealflat3(\AppBundle\Entity\Flat $realflat3 = null)
    {
     ...
     * Set realflat4
     *
     * @param \AppBundle\Entity\Flat $realflat4
     *
     * @return Stage
     */
    public function setRealflat4(\AppBundle\Entity\Flat $realflat4 = null)
    {
