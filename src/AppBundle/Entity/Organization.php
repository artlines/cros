 ...
 */
class Organization implements UserInterface, AdvancedUserInterface, \Serializable
{
    /**
     * @var int
     *
     ...
     * Set txtstatus
     *
     * @param \AppBundle\Entity\OrganizationStatus $txtstatus
     *
     * @return Organization
     */
    public function setTxtstatus(\AppBundle\Entity\OrganizationStatus $txtstatus = null)
    {
     ...
     * Get txtstatus
     *
     * @return \AppBundle\Entity\OrganizationStatus
     */
     ...
     * Add otc
     *
     * @param \AppBundle\Entity\OrgToConf $otc
     *
     * @return Organization
     */
    public function addOtc(\AppBundle\Entity\OrgToConf $otc)
    {
        $this->otc[] = $otc;
     ...
     * @param \AppBundle\Entity\OrgToConf $otc
     */
    public function removeOtc(\AppBundle\Entity\OrgToConf $otc)
    {
     ...
     * Set managers
     *
     * @param \AppBundle\Entity\ManagerGroup $managers
     *
     * @return Organization
     */
    public function setManagers(\AppBundle\Entity\ManagerGroup $managers = null)
    {
