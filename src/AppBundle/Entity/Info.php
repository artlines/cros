...
class Info
{
     ...
     * Add conftoinfo
     *
     * @param \AppBundle\Entity\InfoToConf $conftoinfo
     *
     * @return Info
     */
    public function addConftoinfo(\AppBundle\Entity\InfoToConf $conftoinfo)
    {
     ...
     * @param \AppBundle\Entity\InfoToConf $conftoinfo
     */
    public function removeConftoinfo(\AppBundle\Entity\InfoToConf $conftoinfo)
    {
