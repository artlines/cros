...
class Conference
{
     ...
     * Add infotoconf
     *
     * @param \AppBundle\Entity\InfoToConf $infotoconf
     *
     * @return Conference
     */
    public function addInfotoconf(\AppBundle\Entity\InfoToConf $infotoconf)
    {
     ...
     * @param \AppBundle\Entity\InfoToConf $infotoconf
     */
    public function removeInfotoconf(\AppBundle\Entity\InfoToConf $infotoconf)
    {
