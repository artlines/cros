...
class ManagerGroup
{
     ...
     * Add managed
     *
     * @param \AppBundle\Entity\Organization $managed
     *
     * @return ManagerGroup
     */
    public function addManaged(\AppBundle\Entity\Organization $managed)
    {
     ...
     * @param \AppBundle\Entity\Organization $managed
     */
    public function removeManaged(\AppBundle\Entity\Organization $managed)
    {
