...
class AdminApartamentController extends Controller
{
     ...
     * @return object
     */
    public function adminApartamentTextAction(Request $request)
    {
     ...
     * @return object
     */
    public function priceAction($year = null, Request $request)
    {
        $result = false;
     ...
     */
    public function editApartamentAction($id, Request $request)
    {
        $result = false;
     ...
     * @return object
     */
    public function removeApartamentAction($id, Request $request){
        /** @var Apartament $apartament */
        $apartament = $this->getDoctrine()
            ->getRepository('AppBundle:Apartament')
            ->find($id);
