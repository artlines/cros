...
class AdminClassesController extends Controller
{
     ...
     * @return object
     */
    public function adminClassesAction($year = null, $signed = 'all')
    {
        /** @var Conference $conf */
    ...
    public function setNumberAction(Request $request){
        ...
        $flatRepository = $this->getDoctrine()->getRepository('AppBundle:Flat');
        /** @var Flat $flat */
     ...
     * @return object
     */
    public function saveClassesAction(Request $request)
    {
     ...
     * @return object
     */
    public function saveCorpusesAction(Request $request)
    {
        $save_json = $request->get('save');
        $save = json_decode($save_json, 1);
        $em = $this->getDoctrine()->getManager();
     ...
     */
    public function classBlockAction(Request $request){
     ...
     * @return object
     */
    public function adminCorpusesAction($year){
        /** @var Conference $conf */
        $conf = $this->getDoctrine()
            ->getRepository('AppBundle:Conference')
            ->findOneBy(array('year' => $year));
        ...
        $apartamentPairRepository = $this->getDoctrine()->getRepository('AppBundle:ApartamentPair');
